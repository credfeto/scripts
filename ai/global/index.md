...
| [coverage-ratchet.instructions.md](coverage-ratchet.instructions.md) | Acting as Orchestrator running the AI Coverage board phase, or capturing/posting a coverage baseline as part of issue-to-PR creation or a rebase | Whole-repo per-language coverage ratchet: main-baseline capture, checkout-swap re-baseline, PR baseline comment format, per-language extraction commands, phase decision procedure |
